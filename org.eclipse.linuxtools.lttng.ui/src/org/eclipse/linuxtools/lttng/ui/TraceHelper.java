...
public class TraceHelper {
    ...
    public static String getTraceLibDirFromProject(IProject project) {
        if (project != null && project.exists()) {
            return getProjectPreference(project, "traceLibraryPath");
        }
        return null;
    }
     ...
     */
    public static String getProjectPreference(IProject project,
            String preferenceName) {
        if (project.exists()) {
            IEclipsePreferences prefs = new ProjectScope(project)
                    .getNode("org.eclipse.linuxtools.lttng.jni");
     ...
     */
    public static boolean setProjectPreference(IProject project,
     ...
     */
    public static boolean removeProjectPreference(IProject project,
            String preferenceName) {
        if (project.exists()) {
            IEclipsePreferences prefs = new ProjectScope(project)
                    .getNode("org.eclipse.linuxtools.lttng.jni");
