...
package org.eclipse.tracecompass.analysis.profiling.core.symbols;
 ...
 * <code>org.eclipse.tracecompass.analysis.profiling.core.symbolProvider</code> extension
 * point.
 *
 * @author Robert Kiss
 * @since 3.0
...
public final class SymbolProviderManager {
    ...
    private static final String OLD_OLD_EXTENSION_POINT_ID = "org.eclipse.tracecompass.tmf.ui.symbolProvider"; //$NON-NLS-1$
    private static final String OLD_EXTENSION_POINT_ID = "org.eclipse.tracecompass.tmf.core.symbolProvider"; //$NON-NLS-1$
    private static final String EXTENSION_POINT_ID = "org.eclipse.tracecompass.analysis.profiling.core.symbolProvider"; //$NON-NLS-1$
    ...
    private SymbolProviderManager() {
        ...
        load(OLD_OLD_EXTENSION_POINT_ID);
        ...
        for (IConfigurationElement element : configElements) {
            if (element != null && ELEM_NAME_PROVIDER.equals(element.getName())) {
                try {
                    ...
                    Activator.getInstance().logError("Exception while loading extensions", e); //$NON-NLS-1$
                }
            }
        }
    }
