 ...
 */
public class SOMEIP_SDEndpoint extends ProtocolEndpoint {
     ...
     *            packet.
     */
    public SOMEIP_SDEndpoint(SOMEIP_SDPacket packet, boolean isSourceEndpoint) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof SOMEIP_SDEndpoint)) {
            return false;
        }

        SOMEIP_SDEndpoint other = (SOMEIP_SDEndpoint) obj;
