...
public class TmfMultiTraceExperimentTest {
    ...
    private static ITmfTrace[] setupTraces() {
        try {
            ...
            final TmfTraceStub trace1 = new TmfTraceStub(TmfTestTrace.O_TEST_10K.getPath(), 0, true, null);
            traces[0] = trace1;

            final TmfTraceStub trace2 = new TmfTraceStub(TmfTestTrace.E_TEST_10K.getPath(), 0, true, null);
            traces[1] = trace2;
